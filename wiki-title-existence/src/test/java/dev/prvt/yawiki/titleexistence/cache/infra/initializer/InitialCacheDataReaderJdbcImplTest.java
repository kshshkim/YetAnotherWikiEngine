...
class InitialCacheDataReaderJdbcImplTest {
    ...
    int TITLE_COUNT = 20;
    int READ_MARGIN = 60;
    List<WikiPageTitle> activeTitles = Stream.generate(CommonFixture::aWikiPageTitle)
                                          .limit(TITLE_COUNT).toList();
    List<WikiPageTitle> inactiveTitles = Stream.generate(CommonFixture::aWikiPageTitle)
                                             .limit(TITLE_COUNT).toList();
